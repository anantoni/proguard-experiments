...
public class DialogAddressWithShowPrivateKey extends CenterDialog implements View
    ...
    public void onDismiss(DialogInterface dialog) {
        if (clickedView == R.id.ll_origin_qr_code) {
            dialogQr.show();

        } else if (clickedView == R.id.tv_view_show_private_key) {
            new DialogPassword(activity, this).show();

        } else if (clickedView == R.id.tv_private_key_qr_code_encrypted) {
            new DialogPassword(activity, this).show();

        } else if (clickedView == R.id.tv_private_key_qr_code_decrypted) {
            new DialogPassword(activity, this).show();

        } else if (clickedView == R.id.tv_private_key_qr_code_bip38) {
            new DialogPassword(activity, this).show();

        } else if (clickedView == R.id.tv_trash_private_key) {
        ...
        } else if (clickedView == R.id.ll_sign_message) {
        ...
        } else if (clickedView == R.id.ll_address_alias) {
    ...
    public void onPasswordEntered(final SecureCharSequence password) {
        ...
        if (clickedView == R.id.tv_private_key_qr_code_encrypted) {
            password.wipe();
